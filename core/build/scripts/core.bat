...
set CLASSPATH=%APP_HOME%\lib\core-v1.jar;%APP_HOME%\lib\json-20190722.jar


@rem Execute core
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CORE_OPTS%  -classpath "%CLASSPATH%" com.giuseppelamalfa.gameofliferemastered.ApplicationFrame %*
