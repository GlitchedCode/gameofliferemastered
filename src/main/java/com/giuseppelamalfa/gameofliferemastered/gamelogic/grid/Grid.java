...
public class Grid implements Serializable, Cloneable
{
     ...
     */
    public final ArrayList<PlayerData> getPlayerRankings() { return orderedPlayers; }

    /**
     * Resizes the playing field, removing any units that would be out
     * of bounds after resizing.
     * 
     ...
     * @param row
     * @param col
     * @return Returns unit at provided location, or null if none is present 
     * or if location is out of bounds.
     */
    public final UnitInterface getUnit(int row, int col) { return board.get(row, col); }
     ...
     * @throws Exception 
     */
    public synchronized final void computeNextTurn() throws Exception {
     ...
     */
    public final void setPlayerIDCheckNextTurn() { runPlayerIDCheck = true; }
